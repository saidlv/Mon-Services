...
import 'language_selection_drop_down.dart';

class BuyerAccountLanguage extends StatefulWidget {
  final int selectedIndex;

  BuyerAccountLanguage({Key? key, required this.selectedIndex})
      : super(key: key);

  @override
  _BuyerAccountLanguageState createState() => _BuyerAccountLanguageState();
}

class _BuyerAccountLanguageState extends State<BuyerAccountLanguage> {
  ...
  AppBar appBar(screenWidth) {
    return AppBar(
        ...
        title: text('Language', screenWidth * 5, theme.mainColor,
