...
class BuyerAccountNotifications extends StatefulWidget {
  final int selectedIndex;

  BuyerAccountNotifications({Key? key, required this.selectedIndex})
      : super(key: key);

  @override
  _BuyerAccountNotificationsState createState() =>
      _BuyerAccountNotificationsState();
}

class _BuyerAccountNotificationsState extends State<BuyerAccountNotifications> {
