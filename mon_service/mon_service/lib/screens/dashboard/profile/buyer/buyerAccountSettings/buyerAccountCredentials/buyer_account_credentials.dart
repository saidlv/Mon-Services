...
class BuyerAccountCredentials extends StatefulWidget {
  final int selectedIndex;

  BuyerAccountCredentials({Key? key, required this.selectedIndex})
      : super(key: key);

  @override
  _BuyerAccountCredentialsState createState() =>
      _BuyerAccountCredentialsState();
}

class _BuyerAccountCredentialsState extends State<BuyerAccountCredentials> {
