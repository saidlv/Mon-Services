...
class SellerAccountSecurity extends StatefulWidget {
  final int selectedIndex;

  SellerAccountSecurity({Key? key, required this.selectedIndex})
      : super(key: key);

  @override
  _SellerAccountSecurityState createState() => _SellerAccountSecurityState();
}

class _SellerAccountSecurityState extends State<SellerAccountSecurity> {
